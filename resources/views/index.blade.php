...
@section('content')
    ...
    <div id="jssor_1" style="position:relative;margin:0 auto;top:0px;left:0px;width:1600px;height:560px;overflow:hidden;visibility:hidden;">
        ...
        <div data-u="loading" class="jssorl-009-spin" style="position:absolute;top:0px;left:0px;width:100%;height:100%;text-align:center;background-color:rgba(0,0,0,0.7);">
            <img style="margin-top:-19px;position:relative;top:50%;width:38px;height:38px;" src="temp/index/slider/img/spin.svg" />
        </div>
        <div data-u="slides" style="cursor:default;position:relative;top:0px;left:0px;width:1600px;height:560px;overflow:hidden;">
            <div>
                <img data-u="image" data-src="temp/index/slider/img/1.jpg" />
...
{{--                <img data-u="image" style="opacity:0.8;" data-src="temp/index/slider/img/1.jpg" />--}}
...
{{--            </div>--}}
            ...
            <div>
                <img data-u="image" data-src="temp/index/slider/img/1.jpg" />
                <div data-ts="flat" data-p="1080" style="left:0px;top:0px;width:1600px;height:560px;position:absolute;">
                    <div data-to="50% 50%" data-t="14" style="left:690px;top:140px;width:600px;height:150px;position:absolute;opacity:0;color:#ffffff;font-size:60px;line-height:1.2;letter-spacing:0.1em;">سگ ها و گربه ها<br/>وسایل ...</div>
                    <img data-to="50% 50%" data-t="15" style="left:780px;top:350px;width:344px;height:157px;position:absolute;opacity:0;max-width:344px;" data-src="temp/index/slider/Untitled-3.jpg" />
                    <img data-to="50% 50%" data-t="16" style="left:1330px;top:8px;width:172px;height:131px;position:absolute;opacity:0;max-width:172px;" data-src="temp/index/slider/Untitled-2.jpg" />
                </div>
            </div>
        </div>
        <!-- Bullet Navigator -->
