      ...
      <div class="container">
        <div class="row bg-white">
          ...
          <div class="col-12 col-md-6 col-lg-5 text-right">
            ...
            <div class="mx-4 small my-3">
              <div class="mb-3">
                <i class="fas fa-star star-gold"></i>
                <span>4.2</span>
                <span class="cat-item-page small">(3 نظر)</span>
              </div>
            ...
            <div class="card mt-2">
              ...
              <div class="price-font-item text-center border-bottom-item">
                <div class="toman-price-off-item mb-2">
                  <span id="original-price" class="align-middle" data-price="450000">465,000</span><span
                    id="off-percent" class="badge badge-danger badge-pill mr-2">35٪</span>
                </div>
                <span id="price" data-price="290000">300,000</span><span class="toman-price">تومان</span>
              </div>
        ...
        <div class="row">
          <nav>
            <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
              <a class="nav-item nav-lin active" id="nav-home-tab" data-toggle="tab" href="#nav-home" role="tab"
                 aria-controls="nav-home" aria-selected="true"><i class="fas fa-align-justify ml-2"></i>مشخصات محصول</a>
              <a class="nav-item nav-lin" id="nav-profile-tab" data-toggle="tab" href="#nav-profile" role="tab"
                 aria-controls="nav-profile" aria-selected="false"><i class="fas fa-glasses ml-2"></i>نقد
                و بررسی</a>
              <a class="nav-item nav-lin" id="nav-contact-tab" data-toggle="tab" href="#nav-contact" role="tab"
          ...
          <div class="tab-content col-12" id="nav-tabContent">
            <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
              <div class="row my-4">
                ...
                <div class="col-8 col-md-10 mb-2">
                  <div class="text-item-cat text-right">
                    <p>گوشت مرغ تازه ، ذرت ، پودر گوشت مرغ ، پودرگوشت قرمز ، گندم ، گلوتن ، ماکارونی ، پودر استخوان ،
                      پودر تخم مرغ کامل ، مولتی ویتامین مواد معدنی کمیاب ، طعم دهنده طبیعی ، ویتامین E ، و آنتی اکسیدان
            ...
            <div class="tab-pane fade text-justify px-4 py-4 " id="nav-profile" role="tabpanel"
              ...
              <p>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ، و با استفاده از طراحان گرافیک است،
                <strong>چاپگرها و متون</strong> بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است، و برای شرایط فعلی
                ...
                <div class="col-12 col-lg-7 order-2 order-lg-1">
                  ...
                  <div>
                    <div class="text-right d-flex my-3">
                      ...
                      <div class="box-comment text-justify">
                        از نظر قیافه و آنتن دهی مناسب هست و ارزش خرید داره البته کیفیت بدنه پلاستیک خیلی
                  ...
                  <div>
                    <div class="text-right d-flex my-3">
                      ...
                      <div class="box-comment text-justify">
                        سلام هر کی میخواد پولشو بریز دور بخره من خریدم با توجه به تعریفای که دوستان کرده
                        بودن ولی دو هفته بیشتر کار نکرد داخلش باطری شارژی داره که به علت زیاد موندن
                        رادیو در انبار باطری خالی کرده برای تعویض باطری حدود ۲۰۰ هزار تومان هزینه داره
                      </div>
                    </div>
                  </div>
                  <div>
